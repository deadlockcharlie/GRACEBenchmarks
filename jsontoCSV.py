...
def json_to_csv_and_ids(json_file: str, csv_file: str, ids_file: str, id_key: str):
...
if __name__ == "__main__":
    ...
    json_to_csv_and_ids(vertices_json, vertices_csv, vertices_ids, id_key="_id")

    # Process edges
    edges_json = sys.argv[2]
    edges_csv = Path(edges_json).with_suffix(".csv")
    edges_ids = Path(edges_json).with_suffix(".loaded")
    json_to_csv_and_ids(edges_json, edges_csv, edges_ids, id_key="_id")