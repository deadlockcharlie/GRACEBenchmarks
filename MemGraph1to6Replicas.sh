...
bin/ycsb.sh run grace -P workloads/workload_grace -p  HOSTURI="http://localhost:3000" -p DBTYPE="memgraph" -p DBURI="bolt://localhost:7687" -p maxexecutiontime=60 -p threadcount=1 > $RESULTS_DIRECTORY/MemGraph/1.txt
...
#Run the benchmark with memgraph workload
echo "Running YCSB benchmark with Grace workload"
bin/ycsb.sh run grace -P workloads/workload_grace -p  HOSTURI="http://localhost:3000" -p DBTYPE="memgraph" -p DBURI="bolt://localhost:7687" -p maxexecutiontime=60 -p threadcount=1 > $RESULTS_DIRECTORY/MemGraph/2.txt
# Switch to GRACE directory
cd $LF_DIRECTORY
# Tear down the deployment
python3 Deployment.py down $DIST_CONF
...
#Run the benchmark with memgraph workload
echo "Running YCSB benchmark with Grace workload"
bin/ycsb.sh run grace -P workloads/workload_grace -p  HOSTURI="http://localhost:3000" -p DBTYPE="memgraph" -p DBURI="bolt://localhost:7687" -p maxexecutiontime=60 -p threadcount=1 > $RESULTS_DIRECTORY/MemGraph/3.txt
# Switch to GRACE directory
cd $LF_DIRECTORY
# Tear down the deployment
python3 Deployment.py down $DIST_CONF
...
# Benchmark memgraph with 4 replicas
cd $LF_DIRECTORY
echo "Benchmarking Memgraph with 4 Replicas"
#Create a distribution configuration 
cat > $DIST_CONF <<EOL
{
  "base_website_port": 7474,
...
#Run the benchmark with memgraph workload
echo "Running YCSB benchmark with Grace workload"
bin/ycsb.sh run grace -P workloads/workload_grace -p  HOSTURI="http://localhost:3000" -p DBTYPE="memgraph" -p DBURI="bolt://localhost:7687" -p maxexecutiontime=60 -p threadcount=1 > $RESULTS_DIRECTORY/MemGraph/4.txt
# Switch to GRACE directory
cd $LF_DIRECTORY
# Tear down the deployment
python3 Deployment.py down $DIST_CONF
...
cd $LF_DIRECTORY
echo "Benchmarking Memgraph with 5 Replicas"
#Create a distribution configuration
cat > $DIST_CONF <<EOL
{
  "base_website_port": 7474,
...
# Replica5 → Replica1 = 150ms, Replica5 → Replica2 = 50
...
#Run the benchmark with memgraph workload
echo "Running YCSB benchmark with Grace workload"
bin/ycsb.sh run grace -P workloads/workload_grace -p  HOSTURI="http://localhost:3000" -p DBTYPE="memgraph" -p DBURI="bolt://localhost:7687" -p maxexecutiontime=60 -p threadcount=1 > $RESULTS_DIRECTORY/MemGraph/5.txt
# Switch to GRACE directory
cd $LF_DIRECTORY   
# Tear down the deployment
python3 Deployment.py down $DIST_CONF
...
#Run the benchmark with memgraph workload
echo "Running YCSB benchmark with Grace workload"
bin/ycsb.sh run grace -P workloads/workload_grace -p  HOSTURI="http://localhost:3000" -p DBTYPE="memgraph" -p DBURI="bolt://localhost:7687" -p maxexecutiontime=60 -p threadcount=1 > $RESULTS_DIRECTORY/MemGraph/6.txt
# Switch to GRACE directory
cd $LF_DIRECTORY  
# Tear down the deployment
python3 Deployment.py down $DIST_CONF
