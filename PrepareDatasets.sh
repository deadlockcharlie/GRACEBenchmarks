...
if [ ! -f $DATA_DIRECTORY/frbl.json ]; then 
    # curl https://zenodo.org/records/15571202/files/freebase_large.tar.gz?download=1 > $DATA_DIRECTORY/frbl.tar.gz
    tar -xvzf $DATA_DIRECTORY/frbl.tar.gz -C $DATA_DIRECTORY/
    rm $DATA_DIRECTORY/frbl.tar.gz
fi
